<footer class="bg-Italy_red flex justify-around px-4 text-white">
        ...
        <div class="flex flex-col justify-center">
            <h3 class="pb-2">ons volgen?</h3>
            <div class="flex flex-col gap-4">
                <div class="flex gap-4">
                    <a target="_blank" href="https://www.facebook.com"><img class="h-8" src="{{ asset('images/facebook.png') }}" alt="facebook"></a>
                    <a target="_blank" href="https://www.instagram.com"><img class="h-8" src="{{ asset('images/instagram.png') }}" alt="instagram"></a>
                </div>
                <div class="flex gap-4">
                    <a target="_blank"href="https://www.x.com"><img class="h-8" src="{{ asset('images/x.png') }}" alt="x"></a>
                    <a target="_blank" href="https://www.linkedin.com"><img class="h-8" src="{{ asset('images/linkedin.png') }}" alt="linkedin"></a>
                </div>
            </div>
        </div>
</footer>